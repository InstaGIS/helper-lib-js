...
import {
	default as compact
} from 'lodash-es/compact.js';
import {
	default as each
} from 'lodash-es/each.js';
import {
	default as filter
} from 'lodash-es/filter.js';
import {
	default as flatten
} from 'lodash-es/flatten.js';
import {
	default as groupBy
} from 'lodash-es/groupBy.js';
import {
	default as isEmpty
} from 'lodash-es/isEmpty.js';
import {
	default as keys
} from 'lodash-es/keys.js';
import {
	default as map
...
import {
	default as template
} from 'lodash-es/template.js';
import {
	default as templateSettings
} from 'lodash-es/templateSettings.js';
import {
	default as uniq
